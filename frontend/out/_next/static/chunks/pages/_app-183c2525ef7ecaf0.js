 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}(n)),(0,i.KN)(rl,ru,"esm2017")},9734:function(e,t,r){"use strict";r.d(t,{J$:function(){return ee},ZP:function(){return et}});var n,i=r(7294),s=r(1688);let a=()=>{},o=a(),l=Object,u=e=>e===o,h=e=>"function"==typeof e,c=(e,t)=>({...e,...t}),d=e=>h(e.then),f=new WeakMap,p=0,g=e=>{let t,r;let n=typeof e,i=e&&e.constructor,s=i==Date;if(l(e)!==e||s||i==RegExp)t=s?e.toJSON():"symbol"==n?e.toString():"string"==n?JSON.stringify(e):""+e;else{if(t=f.get(e))return t;if(t=++p+"~",f.set(e,t),i==Array){for(r=0,t="@";r<e.length;r++)t+=g(e[r])+",";f.set(e,t)}if(i==l){t="#";let n=l.keys(e).sort();for(;!u(r=n.pop());)u(e[r])||(t+=r+":"+g(e[r])+",");f.set(e,t)}}return t},m=new WeakMap,y={},v={},w="undefined",E=typeof window!=w,_=typeof document!=w,b=()=>E&&typeof window.requestAnimationFrame!=w,T=(e,t)=>{let r=m.get(e);return[()=>!u(t)&&e.get(t)||y,n=>{if(!u(t)){let i=e.get(t);t in v||(v[t]=i),r[5](t,c(i,n),i||y)}},r[6],()=>!u(t)&&t in v?v[t]:!u(t)&&e.get(t)||y]},I=!0,[S,C]=E&&window.addEventListener?[window.addEventListener.bind(window),window.removeEventListener.bind(window)]:[a,a],A={initFocus:e=>(_&&document.addEventListener("visibilitychange",e),S("focus",e),()=>{_&&document.removeEventListener("visibilitychange",e),C("focus",e)}),initReconnect:e=>{let t=()=>{I=!0,e()},r=()=>{I=!1};return S("online",t),S("offline",r),()=>{C("online",t),C("offline",r)}}},k=!i.useId,R=!E||"Deno"in window,N=e=>b()?window.requestAnimationFrame(e):setTimeout(e,1),O=R?i.useEffect:i.useLayoutEffect,P="undefined"!=typeof navigator&&navigator.connection,D=!R&&P&&(["slow-2g","2g"].includes(P.effectiveType)||P.saveData),L=e=>{if(h(e))try{e=e()}catch(t){e=""}let t=e;return[e="string"==typeof e?e:(Array.isArray(e)?e.length:e)?g(e):"",t]},x=0,M=()=>++x;var U={ERROR_REVALIDATE_EVENT:3,FOCUS_EVENT:0,MUTATE_EVENT:2,RECONNECT_EVENT:1};async function V(...e){let[t,r,n,i]=e,s=c({populateCache:!0,throwOnError:!0},"boolean"==typeof i?{revalidate:i}:i||{}),a=s.populateCache,l=s.rollbackOnError,f=s.optimisticData,p=!1!==s.revalidate,g=e=>"function"==typeof l?l(e):!1!==l,y=s.throwOnError;if(h(r)){let e=[],n=t.keys();for(let i of n)!/^\$(inf|sub)\$/.test(i)&&r(t.get(i)._k)&&e.push(i);return Promise.all(e.map(v))}return v(r);async function v(r){let i;let[s]=L(r);if(!s)return;let[l,c]=T(t,s),[v,w,E,_]=m.get(t),b=v[s],I=()=>p&&(delete E[s],delete _[s],b&&b[0])?b[0](2).then(()=>l().data):l().data;if(e.length<3)return I();let S=n,C=M();w[s]=[C,0];let A=!u(f),k=l(),R=k.data,N=k._c,O=u(N)?R:N;if(A&&c({data:f=h(f)?f(O,R):f,_c:O}),h(S))try{S=S(O)}catch(e){i=e}if(S&&d(S)){if(S=await S.catch(e=>{i=e}),C!==w[s][0]){if(i)throw i;return S}i&&A&&g(i)&&(a=!0,c({data:S=O,_c:o}))}a&&!i&&(h(a)&&(S=a(S,O)),c({data:S,error:o,_c:o})),w[s][1]=M();let P=await I();if(c({_c:o}),i){if(y)throw i;return}return a?P:S}}let F=(e,t)=>{for(let r in e)e[r][0]&&e[r][0](t)},j=(e,t)=>{if(!m.has(e)){let r=c(A,t),n={},i=V.bind(o,e),s=a,l={},u=(e,t)=>{let r=l[e]||[];return l[e]=r,r.push(t),()=>r.splice(r.indexOf(t),1)},h=(t,r,n)=>{e.set(t,r);let i=l[t];if(i)for(let e of i)e(r,n)},d=()=>{if(!m.has(e)&&(m.set(e,[n,{},{},{},i,h,u]),!R)){let t=r.initFocus(setTimeout.bind(o,F.bind(o,n,0))),i=r.initReconnect(setTimeout.bind(o,F.bind(o,n,1)));s=()=>{t&&t(),i&&i(),m.delete(e)}}};return d(),[e,i,d,s]}return[e,m.get(e)[4]]},[B,z]=j(new Map),$=c({onLoadingSlow:a,onSuccess:a,onError:a,onErrorRetry:(e,t,r,n,i)=>{let s=r.errorRetryCount,a=i.retryCount,o=~~((Math.random()+.5)*(1<<(a<8?a:8)))*r.errorRetryInterval;(u(s)||!(a>s))&&setTimeout(n,o,i)},onDiscarded:a,revalidateOnFocus:!0,revalidateOnReconnect:!0,revalidateIfStale:!0,shouldRetryOnError:!0,errorRetryInterval:D?1e4:5e3,focusThrottleInterval:5e3,dedupingInterval:2e3,loadingTimeout:D?5e3:3e3,compare:(e,t)=>g(e)==g(t),isPaused:()=>!1,cache:B,mutate:z,fallback:{}},{isOnline:()=>I,isVisible:()=>{let e=_&&document.visibilityState;return u(e)||"hidden"!==e}}),q=(e,t)=>{let r=c(e,t);if(t){let{use:n,fallback:i}=e,{use:s,fallback:a}=t;n&&s&&(r.use=n.concat(s)),i&&a&&(r.fallback=c(i,a))}return r},H=(0,i.createContext)({}),K=E&&window.__SWR_DEVTOOLS_USE__,G=K?window.__SWR_DEVTOOLS_USE__:[],W=e=>h(e[1])?[e[0],e[1],e[2]||{}]:[e[0],null,(null===e[1]?e[2]:e[1])||{}],Q=()=>c($,(0,i.useContext)(H)),J=G.concat(e=>(t,r,n)=>{let i=r&&((...e)=>{let[n]=L(t),[,,,i]=m.get(B),s=i[n];return u(s)?r(...e):(delete i[n],s)});return e(t,i,n)}),Y=(e,t,r)=>{let n=t[e]||(t[e]=[]);return n.push(r),()=>{let e=n.indexOf(r);e>=0&&(n[e]=n[n.length-1],n.pop())}};K&&(window.__SWR_DEVTOOLS_REACT__=i);let X=i.use||(e=>{if("pending"===e.status)throw e;if("fulfilled"===e.status)return e.value;if("rejected"===e.status)throw e.reason;throw e.status="pending",e.then(t=>{e.status="fulfilled",e.value=t},t=>{e.status="rejected",e.reason=t}),e}),Z={dedupe:!0},ee=l.defineProperty(e=>{let{value:t}=e,r=(0,i.useContext)(H),n=h(t),s=(0,i.useMemo)(()=>n?t(r):t,[n,r,t]),a=(0,i.useMemo)(()=>n?s:q(r,s),[n,r,s]),l=s&&s.provider,u=(0,i.useRef)(o);l&&!u.current&&(u.current=j(l(a.cache||B),s));let d=u.current;return d&&(a.cache=d[0],a.mutate=d[1]),O(()=>{if(d)return d[2]&&d[2](),d[3]},[]),(0,i.createElement)(H.Provider,c(e,{value:a}))},"defaultValue",{value:$}),et=(n=(e,t,r)=>{let{cache:n,compare:a,suspense:l,fallbackData:d,revalidateOnMount:f,revalidateIfStale:p,refreshInterval:g,refreshWhenHidden:y,refreshWhenOffline:v,keepPreviousData:w}=r,[E,_,b,I]=m.get(n),[S,C]=L(e),A=(0,i.useRef)(!1),P=(0,i.useRef)(!1),D=(0,i.useRef)(S),x=(0,i.useRef)(t),F=(0,i.useRef)(r),j=()=>F.current,B=()=>j().isVisible()&&j().isOnline(),[z,$,q,H]=T(n,S),K=(0,i.useRef)({}).current,G=u(d)?r.fallback[S]:d,W=(e,t)=>{for(let r in K)if("data"===r){if(!a(e[r],t[r])&&(!u(e[r])||!a(ea,t[r])))return!1}else if(t[r]!==e[r])return!1;return!0},Q=(0,i.useMemo)(()=>{let e=!!S&&!!t&&(u(f)?!j().isPaused()&&!l&&(!!u(p)||p):f),r=t=>{let r=c(t);return(delete r._k,e)?{isValidating:!0,isLoading:!0,...r}:r},n=z(),i=H(),s=r(n),a=n===i?s:r(i),o=s;return[()=>{let e=r(z()),t=W(e,o);return t?(o.data=e.data,o.isLoading=e.isLoading,o.isValidating=e.isValidating,o.error=e.error,o):(o=e,e)},()=>a]},[n,S]),J=(0,s.useSyncExternalStore)((0,i.useCallback)(e=>q(S,(t,r)=>{W(r,t)||e()}),[n,S]),Q[0],Q[1]),ee=!A.current,et=E[S]&&E[S].length>0,er=J.data,en=u(er)?G:er,ei=J.error,es=(0,i.useRef)(en),ea=w?u(er)?es.current:er:en,eo=(!et||!!u(ei))&&(ee&&!u(f)?f:!j().isPaused()&&(l?!u(en)&&p:u(en)||p)),el=!!(S&&t&&ee&&eo),eu=u(J.isValidating)?el:J.isValidating,eh=u(J.isLoading)?el:J.isLoading,ec=(0,i.useCallback)(async e=>{let t,n;let i=x.current;if(!S||!i||P.current||j().isPaused())return!1;let s=!0,l=e||{},c=!b[S]||!l.dedupe,d=()=>k?!P.current&&S===D.current&&A.current:S===D.current,f={isValidating:!1,isLoading:!1},p=()=>{$(f)},g=()=>{let e=b[S];e&&e[1]===n&&delete b[S]},m={isValidating:!0};u(z().data)&&(m.isLoading=!0);try{if(c&&($(m),r.loadingTimeout&&u(z().data)&&setTimeout(()=>{s&&d()&&j().onLoadingSlow(S,r)},r.loadingTimeout),b[S]=[i(C),M()]),[t,n]=b[S],t=await t,c&&setTimeout(g,r.dedupingInterval),!b[S]||b[S][1]!==n)return c&&d()&&j().onDiscarded(S),!1;f.error=o;let e=_[S];if(!u(e)&&(n<=e[0]||n<=e[1]||0===e[1]))return p(),c&&d()&&j().onDiscarded(S),!1;let l=z().data;f.data=a(l,t)?l:t,c&&d()&&j().onSuccess(t,S,r)}catch(r){g();let e=j(),{shouldRetryOnError:t}=e;!e.isPaused()&&(f.error=r,c&&d()&&(e.onError(r,S,e),(!0===t||h(t)&&t(r))&&B()&&e.onErrorRetry(r,S,e,e=>{let t=E[S];t&&t[0]&&t[0](U.ERROR_REVALIDATE_EVENT,e)},{retryCount:(l.retryCount||0)+1,dedupe:!0})))}return s=!1,p(),!0},[S,n]),ed=(0,i.useCallback)((...e)=>V(n,D.current,...e),[]);if(O(()=>{x.current=t,F.current=r,u(er)||(es.current=er)}),O(()=>{if(!S)return;let e=ec.bind(o,Z),t=0,r=Y(S,E,(r,n={})=>{if(r==U.FOCUS_EVENT){let r=Date.now();j().revalidateOnFocus&&r>t&&B()&&(t=r+j().focusThrottleInterval,e())}else if(r==U.RECONNECT_EVENT)j().revalidateOnReconnect&&B()&&e();else if(r==U.MUTATE_EVENT)return ec();else if(r==U.ERROR_REVALIDATE_EVENT)return ec(n)});return P.current=!1,D.current=S,A.current=!0,$({_k:C}),eo&&(u(en)||R?e():N(e)),()=>{P.current=!0,r()}},[S]),O(()=>{let e;function t(){let t=h(g)?g(z().data):g;t&&-1!==e&&(e=setTimeout(r,t))}function r(){!z().error&&(y||j().isVisible())&&(v||j().isOnline())?ec(Z).then(t):t()}return t(),()=>{e&&(clearTimeout(e),e=-1)}},[g,y,v,S]),(0,i.useDebugValue)(ea),l&&u(en)&&S){if(!k&&R)throw Error("Fallback data is required when using suspense in SSR.");x.current=t,F.current=r,P.current=!1;let e=I[S];if(!u(e)){let t=ed(e);X(t)}if(u(ei)){let e=ec(Z);u(ea)||(e.status="fulfilled",e.value=!0),X(e)}else throw ei}return{mutate:ed,get data(){return K.data=!0,ea},get error(){return K.error=!0,ei},get isValidating(){return K.isValidating=!0,eu},get isLoading(){return K.isLoading=!0,eh}}},function(...e){let t=Q(),[r,i,s]=W(e),a=q(t,s),o=n,{use:l}=a,u=(l||[]).concat(J);for(let e=u.length;e--;)o=u[e](o);return o(r,i||a.fetcher||null,a)})},7582:function(e,t,r){"use strict";r.d(t,{ZT:function(){return i},_T:function(){return a},pi:function(){return s}});var n=function(e,t){return(n=Object.setPrototypeOf||({__proto__:[]})instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])})(e,t)};function i(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Class extends value "+String(t)+" is not a constructor or null");function r(){this.constructor=e}n(e,t),e.prototype=null===t?Object.create(t):(r.prototype=t.prototype,new r)}var s=function(){return(s=Object.assign||function(e){for(var t,r=1,n=arguments.length;r<n;r++)for(var i in t=arguments[r])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e}).apply(this,arguments)};function a(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&0>t.indexOf(n)&&(r[n]=e[n]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols)for(var i=0,n=Object.getOwnPropertySymbols(e);i<n.length;i++)0>t.indexOf(n[i])&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]]);return r}"function"==typeof SuppressedError&&SuppressedError}},function(e){var t=function(t){return e(e.s=t)};e.O(0,[774,179],function(){return t(1118),t(8355)}),_N_E=e.O()}]);